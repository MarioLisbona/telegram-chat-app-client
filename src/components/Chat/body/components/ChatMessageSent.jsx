      ...
      <div className="flex flex-col items-end">
        ...
        <div className="flex items-start justify-end">
          <div className="flex row-reverse">
            <div className="relative mr-3 text-sm text-white font-medium bg-indigo-500 py-2 px-4 shadow rounded-xl rounded-tr-none max-w-1/2 break-words break-all whitespace-pre-wrap">
              <div>{text}</div>
            </div>
            <div
